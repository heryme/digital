...
public class SnacksFoodAdapter extends BaseAdapter {

    Context context;
    ArrayList<FoodHistory> list;
    private LayoutInflater inflater;

    public SnacksFoodAdapter(Context context, ArrayList<FoodHistory> list) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        if (foodHistory != null) {
            ...
            viewHolder.tvFoodName.setText(foodHistory.getFoodName().trim());
            viewHolder.tvFoodDesc.setText(foodHistory.getDescription().trim());
