...
public class BreackFastFoodAdapter extends BaseAdapter {

    Context context;
    ArrayList<FoodHistory> list;
    private LayoutInflater inflater;

    public BreackFastFoodAdapter(Context context, ArrayList<FoodHistory> list) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        Log.d("Test Adapter","Get view Call >> list size >>"+list.size());
